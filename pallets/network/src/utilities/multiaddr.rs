...
//         let peer = [7u8; 32];
//         let peer_str = bs58::encode(&peer).into_string();

//         let addr_str = format!(
//             "/dns4/node.example.com/tcp/443/ws/p2p/{}",
//             peer_str
//         );
...
//         let addr_str = format!(
//             "/dns6/node.example.com/tcp/443/wss/p2p/{}",
//             peer_str
//         );
...
//         let addr_str = format!("/ip4/127.0.0.1/tcp/8080/p2p/{}", peer_str);
//         let ma = Multiaddr::from_str(&addr_str).unwrap();
//         let segs = ma.to_vec().unwrap();

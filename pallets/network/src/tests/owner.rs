...
use crate::{
    ...
    NonAttestorDecreaseReputationFactor, NonConsensusAttestorDecreaseReputationFactor, PeerInfo,
...
fn test_owner_unpause_subnet_verify_queue_updated() {
    new_test_ext().execute_with(|| {
        ...
        build_registered_nodes_in_queue_v2(subnet_id, start, end, deposit_amount, stake_amount);
...
fn test_owner_update_name() {
    new_test_ext().execute_with(|| {
        ...
        build_activated_subnet_v2(subnet_name_2.clone(), 0, 4, deposit_amount, stake_amount);
